...
local Rayfield = loadstring(game:HttpGet('https://raw.githubusercontent.com/x7ry/Rayfield/main/source.lua'))()
...
-- // CRÉATION DU MENU RAYFIELD CARRÉ
local Window = Rayfield:CreateWindow({
    Name = "Moon Menu",
    Icon = 0, -- Icon (0 = Default)
    LoadingTitle = "Moon Menu",
    LoadingSubtitle = "by Milky",
    Theme = "Dark", -- Dark, Light, Default
    DisableRayfieldPrompts = false,
    DisableBuildWarnings = false, -- Avertissements de build
    ConfigurationSaving = {
       Enabled = true,
       FolderName = "MoonHub", -- Dossier de configuration
       FileName = "Config"
    },
    Discord = {
       Enabled = false,
       Invite = "noinvitelink", -- Discord invite
       RememberJoins = true
    },
    KeySystem = false, -- Système de clé
    KeySettings = {
       Title = "Moon Menu",
       Subtitle = "Key System",
...
chat_services.Print("Moon script chargé avec Rayfield ! Appuyez sur RightShift pour afficher le menu")

-- Correction du raccourci RightShift pour ouvrir/fermer Rayfield (optionnel)
